...
const styles = StyleSheet.create({
  ...
  modalHeaderTitle: { fontSize: 18, fontWeight: '700', color: '#f1f5f9', flexShrink: 1, adjustsFontSizeToFit: true, minFontSize: 14 },
  ...
  actionBtnText: { fontSize: 14, fontWeight: '600', flexShrink: 1, adjustsFontSizeToFit: true, minFontSize: 11 },
