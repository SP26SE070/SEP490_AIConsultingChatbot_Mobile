...
const styles = StyleSheet.create({
  ...
  selectPlanBtnText: { fontSize: 15, fontWeight: '600', color: '#fff', flexShrink: 1, adjustsFontSizeToFit: true, minFontSize: 11 },
  ...
  confirmModalTitle: { fontSize: 18, fontWeight: '700', color: '#f8fafc', marginBottom: 14, flexShrink: 1, adjustsFontSizeToFit: true, minFontSize: 14 },
