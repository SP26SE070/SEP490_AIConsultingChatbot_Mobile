...
const styles = StyleSheet.create({
  ...
  tabLabel: { fontSize: 13, color: '#64748b', fontWeight: '500', flexShrink: 1, adjustsFontSizeToFit: true, minFontSize: 10 },
  ...
  docInfo: { flex: 1 },
  docTitle: { fontSize: 15, fontWeight: '600', color: '#f1f5f9', marginBottom: 4, flexShrink: 1, adjustsFontSizeToFit: true, minFontSize: 11 },
  ...
  catInfo: { flex: 1 },
  catName: { fontSize: 14, fontWeight: '600', color: '#f1f5f9', flexShrink: 1, adjustsFontSizeToFit: true, minFontSize: 11 },
  ...
  tagInfo: { flex: 1 },
  tagName: { fontSize: 16, fontWeight: '600', color: '#f1f5f9', flexShrink: 1, adjustsFontSizeToFit: true, minFontSize: 12 },
  ...
  tagActions: { flexDirection: 'row', gap: 2 },
  ...
  modalTitle: { fontSize: 18, fontWeight: '700', color: '#f1f5f9', flexShrink: 1, adjustsFontSizeToFit: true, minFontSize: 14 },
  modalScroll: { flex: 1 },
  ...
  submitBtnText: { fontSize: 15, color: '#fff', fontWeight: '600', minFontSize: 10, adjustsFontSizeToFit: true, numberOfLines: 1 },
});
